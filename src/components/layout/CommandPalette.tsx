...
export function CommandPalette({
  ...
  const staticCommandItems: CommandItem[] = [
    ...
    { id: "nav-contracts", title: "Contracts (OPS Portal)", subtitle: "Client agreements, SLAs, budgets, deliverables & terms", category: "Navigation", icon: "fa-solid fa-file-contract", href: "/dashboard/clients?tab=contracts", moduleKey: "clients", keywords: ["contracts", "client contracts", "agreements", "sow", "rates", "nda", "ops portal"] },
