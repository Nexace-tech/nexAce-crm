...
export function CommandPalette({
  ...
  const staticCommandItems: CommandItem[] = [
    ...
    { id: "nav-drive", title: "Drive Space", subtitle: "Workspace file drive, uploads & documents storage", category: "Navigation", icon: "fa-solid fa-hard-drive", href: "/dashboard/clients?tab=drive", moduleKey: "drive", keywords: ["drive", "files", "cloud", "documents", "storage"] },
