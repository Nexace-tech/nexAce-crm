...
export function CommandPalette({
  ...
  const staticCommandItems: CommandItem[] = [
    ...
    { id: "nav-reports", title: "Reports & Data Exports", subtitle: "Project tasks, timesheets, and shift attendance CSV reports", category: "Navigation", icon: "fa-solid fa-file-lines", href: "/dashboard/reports", moduleKey: "reports", keywords: ["reports", "csv", "exports", "timesheet report", "shift log report", "tasks report"] },
