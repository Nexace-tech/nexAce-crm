...
export function CommandPalette({
  ...
  const staticCommandItems: CommandItem[] = [
    ...
    { id: "nav-projects", title: "Projects & Kanban Boards (OPS Portal)", subtitle: "Agile sprints, Kanban tasks, SOP Wiki & Drive space", category: "Navigation", icon: "fa-solid fa-folder-tree", href: "/dashboard/clients?tab=projects", moduleKey: "clients", keywords: ["tasks", "kanban", "wiki", "gantt", "drive", "projects", "ops portal"] },
    { id: "nav-drive", title: "Drive Space (OPS Portal)", subtitle: "Workspace file drive, folders & documents storage", category: "Navigation", icon: "fa-solid fa-hard-drive", href: "/dashboard/clients?tab=drive", moduleKey: "clients", keywords: ["drive", "files", "cloud", "documents", "storage", "ops portal"] },
    { id: "nav-contracts", title: "Contracts & Onboarding (OPS Portal)", subtitle: "Contractor agreements, SOWs, rates & onboarding checklists", category: "Navigation", icon: "fa-solid fa-file-contract", href: "/dashboard/clients?tab=contracts", moduleKey: "clients", keywords: ["contracts", "onboarding", "contractor", "freelancer", "sow", "rates", "ops portal"] },
    { id: "nav-reports", title: "Reports & Data Exports (OPS Portal)", subtitle: "Project tasks, timesheets, and shift attendance CSV & PDF reports", category: "Navigation", icon: "fa-solid fa-file-lines", href: "/dashboard/clients?tab=reports", moduleKey: "clients", keywords: ["reports", "csv", "exports", "timesheet report", "shift log report", "tasks report", "ops portal"] },
    ...
    { id: "nav-crm", title: "OPS Portal", subtitle: "Operations control, client retainers, HR allocations & reports", category: "Navigation", icon: "fa-solid fa-list-check", href: "/dashboard/clients", moduleKey: "clients", keywords: ["clients", "operations", "ops portal", "projects", "contracts", "reports"] },
    { id: "nav-bd", title: "BD Portal & Proposals", subtitle: "Lead capture, client proposals & business development", category: "Navigation", icon: "fa-solid fa-briefcase", href: "/dashboard/bd", moduleKey: "bd", keywords: ["bd", "leads", "proposals", "business development"] },
    { id: "nav-finance", title: "Finance Portal", subtitle: "Invoices, expense tracking, accounts & budget records", category: "Navigation", icon: "fa-solid fa-coins", href: "/dashboard/finance", moduleKey: "finance", keywords: ["finance", "invoices", "expenses", "payroll", "budget"] },
    ...
    { id: "nav-notifications", title: "Notification Center", subtitle: "System alerts, announcements & workspace notifications", category: "Navigation", icon: "fa-solid fa-bell", href: "/dashboard/notifications", moduleKey: "notifications", keywords: ["notifications", "alerts", "announcements", "broadcasts"] },
    ...
    { id: "act-new-project", title: "Create New Project Board", subtitle: "Add a new agile sprint or team project", category: "Quick Actions", icon: "fa-solid fa-folder-plus text-emerald-500", href: "/dashboard/clients?tab=projects", keywords: ["new project", "add board", "create project"] },
    ...
    { id: "act-wiki", title: "Browse SOPs & Wiki Knowledge", subtitle: "Explore internal company standard operating procedures", category: "Quick Actions", icon: "fa-solid fa-book-bookmark text-sky-500", href: "/dashboard/clients?tab=projects", keywords: ["wiki", "sop", "knowledge", "guide", "procedure"] },
