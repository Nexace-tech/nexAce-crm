...
export function CommandPalette({
  ...
  const staticCommandItems: CommandItem[] = [
    ...
    { id: "nav-sales", title: "Sales Workdesk", subtitle: "Kanban pipeline, deal stages & revenue forecasting", category: "Navigation", icon: "fa-solid fa-handshake", href: "/dashboard/sales", moduleKey: "sales", keywords: ["sales", "deals", "pipeline", "workdesk", "revenue"] },
